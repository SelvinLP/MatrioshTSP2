...
var Inct = /** @class */ (function (_super) {
    __extends(Inct, _super);
    function Inct(id, linea, columna) {
        var _this = _super.call(this, linea, columna) || this;
        _this.id = id;
        return _this;
    }
    Inct.prototype.ejecutar = function (entorno) {
    ...
    Inct.prototype.ejecutarast = function (ast) {
